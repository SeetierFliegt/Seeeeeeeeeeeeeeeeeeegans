...
for(let i = 0; i < spTime.length; i++)
{
     time[i] = parseInt(spTime[i][2])-parseInt(min(spTime));
}
for(let i = 0; i < spHoehe.length; i++)
{
...
const heigthAchse = []; 
let zl = 0;
heigthAchse.length = spHoehe.length;
for(let i = 0; i < spHoehe.length; i++)
{
  
  heigthAchse[i] = parseInt((diff(spHoehe)/spHoehe.length)*(i));
...
table.insertRow().insertCell().innerHTML = "Maximale Höhe in m: "+max(spHoehe);
table.insertRow().insertCell().innerHTML = "Minimale Höhe in m: "+min(spHoehe);
table.insertRow().insertCell().innerHTML = "Höhenunterschied in m: "+diff(spHoehe);
...
table.insertRow().insertCell().innerHTML = "Maximaler Druck in hPa: "+max(spPress);
table.insertRow().insertCell().innerHTML = "Minimaler Druck in hPa: "+min(spPress);
table.insertRow().insertCell().innerHTML = "druckunterschied in hPa: "+diff(spPress);
...
table.insertRow().insertCell().innerHTML = "Maximale Luftfeuchtigkeit in %: "+max(spHum);
table.insertRow().insertCell().innerHTML = "Minimale Luftfeuchtigkeit in %: "+min(spHum);
